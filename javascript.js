...
//         this.operationButtons = document.querySelectorAll('.operations');
...
//             button.addEventListener('click', this.addOperation.bind(this));
//         });
...
//         // Only proceed if there's already a number input
//         if (this.inputString.trim() !== "") {
//             const number = parseFloat(this.inputString);

//             // Update the total balance based on the operation
//             if (operation === '+') {
//                 this.totalBalance += number;
//                 this.appendStatement(number, '+');
//             } else if (operation === '-') {
//                 this.totalBalance -= number;
//                 this.appendStatement(number, '-');
//             }
...
//             // Reset the input string and display
//             this.inputString = "";
//             this.display.value = this.inputString;
//         }
//     }
...
//     appendStatement(number, operation) {
//         const newStatement = document.createElement('p');
//         newStatement.textContent = `${operation} ${number}`;
...
// // BudgetCalculator class when the DOM is fully loaded 
